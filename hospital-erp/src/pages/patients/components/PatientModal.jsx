...
export default function PatientModal({ isOpen, mode, patient, onClose, onSubmit, loading }) {
  // ESC to close
  useEffect(() => {
    if (!isOpen) return;
  ...
  // Map patient data → form default values
  const defaultValues = patient
    ? {
        ...
        city:        patient.city        || '',
        state:       patient.state       || (patient.isActive ? 'Active' : 'Inactive'),
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    width: 40, height: 40,
                    background: isEdit ? '#EEF2FF' : '#F0FDF4',
                  }}
                >
                  {isEdit
                ...
                <div>
                  ...
                  <p style={{ fontSize: 12, color: '#94A3B8', marginTop: 2 }}>
                    {isEdit
                      ? `Updating record for ${patient?.name}`
